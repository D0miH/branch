declare module "identicon.js" {
    ...
    class Svg {
        ...
        foreground: Color;
        background: Color;
        rectangles: [{ x: number; y: number; width: number; height: number; color: Color }];
    ...
    export default class Identicon {
         ...
         */
        rectangle(x: number, y: number, w: number, h: number, color: Color, image: Svg | PNGlib);
         ...
         * @param b brightness
         */
        hsl2rgb(h, s, b): [number, number, number];
